...
Κανόνες:
- **Όριο μάθησης** (`learning_cap_targets`, 12 σημεία ≈ 6 λέξεις): νέα λέξη
  παρουσιάζεται μόνο όσο τα σημεία «σε εκμάθηση» είναι λιγότερα. Λέξη που
